...
public class insertion extends javax.swing.JFrame {
       ...
       DefaultTableModel model = (DefaultTableModel) jTable2.getModel(); 
        ...
        try{
            ...
            while(rs.next()){
                ...
                model.addRow(new Object[]{user_id,name,username,password});
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
             ...
             String sqlcode="UPDATE user2 SET name=?, username=?,password=? WHERE user_id=?";
             PreparedStatement stmt = conn.prepareStatement(sqlcode);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try{
        int row = jTable2.getSelectedRow();
        String delete_id=(String)jTable2.getValueAt(row,0);
        String sqlCode="DELETE FROM user2 WHERE user_id = ?";
        PreparedStatement stmt = conn.prepareStatement(sqlCode);
